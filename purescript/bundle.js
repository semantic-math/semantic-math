      ...
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonNumber)(v)("unitsPerEm"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeForeignObject(decodeJsonGlyph))(v)("glyphMetrics"))(function (v2) {
                  var glyphMetrics = Foreign_Object.fold(function (accu) {
                      return function (key) {
                          return function (glyph) {
                              return Data_Map_Internal.insert(Data_Ord.ordChar)(Data_Maybe.fromJust()(Data_Char.fromCharCode(Data_Maybe.fromJust()(Data_Int.fromString(key)))))(glyph)(accu);
                          };
                      };
                  })(Data_Map_Internal.empty)(v2);
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(Effect_Aff.launchAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Console.log("fetching comic-sans.json")))(function () {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
          ...
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
              ...
              Effect_Console.log(Data_Show.show(Data_Map_Internal.showMap(Data_Show.showChar)(Metrics.showGlyph))(v1.glyphMetrics))();
